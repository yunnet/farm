 ...
 * 单元名称: RsaKeyHelper.java  <br />
 * 说        明:  <br />
 * 作        者: yunnet <br />
 * 创建时间: 2018-09-03 17:09:08 <br />
 * 最后修改: 2018-09-03 17:09:08 <br />
 * 修改历史: <br />
 */
...
//        keyPairGenerator.initialize(1024);  
        ...
        //根据密码固定生成
    	String passwrod = "abc123";
        SecureRandom secureRandom = new SecureRandom(passwrod.getBytes());
        keyPairGenerator.initialize(1024, secureRandom);
        ...
        System.out.println("privateKey = " + RsaKeyHelper.toHexString(privateKeyBytes) );
        System.out.println("publicKey = " + RsaKeyHelper.toHexString(publicKeyBytes) );
    }
}